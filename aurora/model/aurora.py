...
LastEditTime: 2024-11-26 19:04:22
LastEditors: DC
Description: 
FilePath: /aurora_co2_3_small/aurora/model/aurora.py
...
class Aurora(torch.nn.Module):
    ...
    def load_checkpoint(self, repo: str, name: str, strict: bool = True) -> None:
        ...
        path = r"C:\Users\DC\Documents\vscode4\aurora_co2_2\aurora-0.25-finetuned.ckpt"
...
AuroraSmall = partial(
    Aurora,
    encoder_depths=(2//2, 6//3, 2//2),
    encoder_num_heads=(4//2, 8//2, 16//8),
    decoder_depths=(2//2, 6//3, 2//2),
    decoder_num_heads=(16//8, 8//4, 4//2),
    embed_dim=256,
    num_heads=8,
    use_lora=False,
)
...
# AuroraSmall = partial(
#     Aurora,
#     encoder_depths=(2, 3, 1),
#     encoder_num_heads=(4, 8, 16),
#     decoder_depths=(2, 3, 1),
#     decoder_num_heads=(16, 8, 4),
#     embed_dim=64,
#     num_heads=8,
#     use_lora=False,
