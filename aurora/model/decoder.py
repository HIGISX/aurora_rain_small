...
class Perceiver3DDecoder(nn.Module):
    ...
    def __init__(
        ...
        self.up= nn.Upsample(size=(720,1440), mode='bilinear', align_corners=True)
    ...
    def forward(
        ...
        surf_preds=self.up(surf_preds)
        # atmos_preds=self.up(atmos_preds)
        # print(type(surf_preds))
        # print(surf_preds.shape)
        # print()
